...
const pages = [
  ...
  },
  {
    ...
    style: {
      navigationBarTitleText: "踏勘"
    }
  },
  {
    path: "pages/construction/index",
    style: {
      navigationBarTitleText: "清洗记录"
    }
  },
  {
    path: "pages/test/test",
    style: {
      navigationBarTitleText: "uniCloud Test"
    }
  },
  {
    path: "pages/business/index",
    style: {
      navigationBarTitleText: "营业管理"
    }
  },
  {
    path: "pages/business/info",
    style: {
      navigationBarTitleText: "基础信息录入"
    }
  },
  {
  ...
  {
    path: "pages/site/status",
    style: {
      navigationBarTitleText: "现场状态"
    }
  },
  {
    path: "pages/construction/info",
    style: {
      navigationBarTitleText: "施工信息录入"
    }
  },
  {
    path: "pages/site/preview",
    style: {
...
const permission = {
  "scope.userLocation": {
    desc: "你的位置信息将用于现场踏勘定位"
  }
};
const globalStyle = {
  navigationBarTextStyle: "black",
  navigationBarTitleText: "业务管理系统",
...
const b = true, E = "mp-weixin", A = T(define_process_env_UNI_SECURE_NETWORK_CONFIG_default), P = E, C = T('{"address":["127.0.0.1","192.168.1.23"],"servePort":7000,"debugPort":9000,"initialLaunchType":"local","skipFiles":["<node_internals>/**","C:/Users/31110/Downloads/HBuilderX/plugins/unicloud/**/*.js"]}'), O = T('[{"provider":"aliyun","spaceName":"digui","spaceId":"mp-9d6e4272-32fd-491b-9348-67b8e8cb0801","clientSecret":"djot1LaIHaYizUFJlk6dMQ==","endpoint":"https://api.next.bspapp.com"}]') || [];
let N = "";
try {
  N = "__UNI__84ABCC1";
} catch (e2) {
